...
GPSD_HOST = os.getenv("NDEFENDER_GPSD_HOST", "127.0.0.1")
GPSD_PORT = int(os.getenv("NDEFENDER_GPSD_PORT", "2947"))
GPS_POLL_INTERVAL_S = float(os.getenv("NDEFENDER_GPS_POLL_INTERVAL_S", "1.0"))
